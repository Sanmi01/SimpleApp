...
router.post('/:user_id/teamsanmis/create', user_controller.create_teamsanmi_post);
...
router.get('/:user_id/teamsanmis/:teamsanmi_id/destroy', user_controller.delete_user_teamsanmi_get);
